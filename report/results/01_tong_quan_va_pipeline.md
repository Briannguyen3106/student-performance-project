...
**Các quyết định dữ liệu đã chốt**:
...
|---|---|---|
| **Thư mục** | `notebooks/core/` | `notebooks/appendix/` |
...
> Notebook 01–04 ở `notebooks/appendix/` và các artifact nâng cao được **giữ làm phụ lục kỹ thuật**,
...
kế thừa toàn bộ bối cảnh, ký hiệu và quy ước ở đây:

| File chi tiết | Nội dung | Phần báo cáo | Hình liên quan (`report/figures/`) |
|---|---|---|---|
