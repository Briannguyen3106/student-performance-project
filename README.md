...
|---|---|---|---|
| **Nguyễn Danh Bảo** | Phase 1 — EDA | `01_EDA.ipynb` | 2/6 |
| **[Tên A]** | Phase 6 — Measurement theory | section trong báo cáo | 9/6 |
| **[Tên B]** | Phase 2 — Hypothesis testing | `02_hypothesis_testing.ipynb` | 7/6 |
| **[Tên B]** | Phase 3 — CI + Bootstrap + Power | `03_confidence_intervals.ipynb` | 7/6 |
| **[Tên C]** | Phase 4 — Regression | `04_regression.ipynb` | 7/6 |
| **[Tên C]** | Phase 5 — DoE simulation | `05_doe_simulation.ipynb` | 7/6 |
| **Cả nhóm** | Tổng hợp báo cáo | `report/report.pdf` | 11/6 |
